        ...
        return (
            <Container className="main-exe-cv-container">
                ...
                <div as="div" className="message-container">
                    ...
                    <Card.Text as="p" className="message-text">Simple, Quick and FREE !!!</Card.Text>
                </div>
                <div as="div" className="exe-cv-container">
                    <div className="exe-cv">
                        <div className="exe-cv-container1">
                            <Figure.Image  as="img"  className="avatar-picture" width={171} height={180} alt="Avatar"  src="http://www.davecrossphotography.com/wp-content/uploads/2011/03/NYC-Headshot-Women-007.jpg" />
                            <br />
                    ...
                    <div className="exe-cv2">
                        <div className="exe-cv-container2">
                            ...
                            <br />
                            <Card.Text className="title" name="companyName">DIGITAL MARKETING ASSISTANT / AMAZON</Card.Text>
                            ...
                            <Card.Text className="title" name="companyName">DIGITAL MARKETING MANEGER / GOOGLE</Card.Text>
                            <i className="fas fa-calendar-alt fa-fw w3-margin-righ" style={{ color: '#279081' }} />
                        ...
                        <div className="exe-cv-container3">
                            ...
                            <Card.Text>Busness Low and Marketing</Card.Text>
